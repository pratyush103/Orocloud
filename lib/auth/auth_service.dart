...
class AuthService {
  ...
  Future<void> signInWithGoogle() async {
    await _supabase.auth.signInWithOAuth(
      ...
      redirectTo: 'https://rkeubgdoirploxifyjmn.supabase.co/auth/v1/callback', //` Change this to your deep link
    );
  }
  ...
  Future<void> restoreSession() async {
    ...
    if (sessionString != null) {
      ...
      final session = Session.fromJson(sessionData); // Convert JSON back to ?Session
